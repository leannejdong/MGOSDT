...
##am__append_4 = $(CL_ADD)
bin_PROGRAMS = gosdt$(EXEEXT) gosdt_test$(EXEEXT)
subdir = .
...
gosdt_LINK = $(CXXLD) $(AM_CXXFLAGS) $(CXXFLAGS) $(gosdt_LDFLAGS) \
	$(LDFLAGS) -o $@
am_gosdt_test_OBJECTS = src/gosdt_test-bitmask.$(OBJEXT) \
	src/gosdt_test-configuration.$(OBJEXT) \
	src/gosdt_test-task.$(OBJEXT) src/gosdt_test-message.$(OBJEXT) \
	src/gosdt_test-tile.$(OBJEXT) src/gosdt_test-graph.$(OBJEXT) \
	src/gosdt_test-queue.$(OBJEXT) src/gosdt_test-model.$(OBJEXT) \
	...
	src/gosdt_test-gosdt.$(OBJEXT) test/gosdt_test-main.$(OBJEXT)
...
DIST_SOURCES = $(gosdt_SOURCES) $(gosdt_test_SOURCES)
