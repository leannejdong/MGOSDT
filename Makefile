...
am__gosdt_test_SOURCES_DIST = src/types.hpp \
	...
	test/test_queue.hpp test/test_consistency.hpp test/main.cpp
...
am__depfiles_remade = src/$(DEPDIR)/gosdt-bitmask.Po \
	...
	test/$(DEPDIR)/gosdt_test-main.Po
am__mv = mv -f
AM_V_lt = $(am__v_lt_$(V))
...
VERSION = 0.1.0
XMKMF = 
abs_builddir = /home/leanne/Dev/concordia/mgosdt
abs_srcdir = /home/leanne/Dev/concordia/mgosdt
abs_top_builddir = /home/leanne/Dev/concordia/mgosdt
abs_top_srcdir = /home/leanne/Dev/concordia/mgosdt
ac_ct_CC = 
ac_ct_CXX = 
am__include = include
am__leading_dot = .
...
test/$(DEPDIR)/$(am__dirstamp):
	@$(MKDIR_P) test/$(DEPDIR)
	@: > test/$(DEPDIR)/$(am__dirstamp)
test/gosdt_test-main.$(OBJEXT): test/$(am__dirstamp) \
	test/$(DEPDIR)/$(am__dirstamp)
...
include test/$(DEPDIR)/gosdt_test-main.Po # am--include-marker
...
distclean: distclean-am
	...
	-rm -f test/$(DEPDIR)/gosdt_test-main.Po
	-rm -f Makefile
